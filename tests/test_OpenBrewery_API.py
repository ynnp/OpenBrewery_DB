...
def test_check_status_code_for_random_brewery():
	...
	assert random_brewery.status_code == 200, "Response code differs from expected"
...
def test_check_status_code_for_valid_single_brewery(get_random_brewery):
	...
	assert single_brewery.status_code == 200, "Response code differs from expected"
...
def test_check_status_code_for_invalid_single_brewery(generate_random_string):
	...
	assert single_brewery.status_code == 404, "Response code differs from expected"
...
def test_check_status_code_for_all_breweries():
	...
	assert all_breweries.status_code == 200, "Response code differs from expected"
...
def test_check_status_code_for_breweries_filtered_by_valid_city(get_random_brewery):
	...
	assert filtered_breweries.status_code == 200, "Response code differs from expected"
...
def test_check_status_code_for_breweries_filtered_by_type(brewery_type, status_code):
	...
	assert filtered_breweries.status_code == status_code, "Response code differs from expected"
